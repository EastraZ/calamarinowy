...
export default function HelpCenterPage() {
  ...
  const categories = [
    {
      ...
      icon: Book,
      description: "Learn the basics of using Calamari.lol",
      articles: [
        "How to install Calamari.lol",
    ...
    },
    {
      title: "Configuration",
      icon: Settings,
      description: "Configure Calamari.lol for optimal performance",
    ...
    },
    {
      ...
      icon: Shield,
      description: "Stay safe while using Calamari.lol",
      articles: [
  ...
  const popularArticles = [
    {
      title: "How to Install Calamari.lol on Windows 10/11",
    ...
    {
      title: "Optimizing Calamari.lol for Rust",
    ...
    <div className="min-h-screen bg-black text-white pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            Find answers to your questions and get the most out of Calamari.lol
          </motion.p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {quickLinks.map((link, index) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-white group-hover:text-red-300 transition-colors font-medium">{link.name}</span>
                  <ChevronRight className="h-5 w-5 text-gray-400 group-hover:text-red-400 transition-colors" />
                </div>
              </motion.a>
            ))}
