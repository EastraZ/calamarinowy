...
import { Shield, Target, Eye, Map, Settings, Star, Users, ShoppingCart, Zap } from "lucide-react"
import Navbar from "@/components/navbar"

export default function RustProductPage() {
  const variants = [
    { name: "Day", price: 9, stock: 15, productId: "35665", variantId: "120121" },
    { name: "3 Days", price: 18, stock: 13, productId: "35666", variantId: "120122" },
    { name: "Week", price: 29, stock: 12, productId: "35667", variantId: "120123" },
    { name: "Month", price: 70, stock: 15, productId: "35668", variantId: "120124" },
    { name: "Lifetime", price: 520, stock: 5, productId: "35669", variantId: "120125" },
  ]
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                <div className="flex flex-col sm:flex-row items-center sm:items-start mb-6">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-red-600/20 to-red-900/20 rounded-full flex items-center justify-center mb-4 sm:mb-0 sm:mr-6 flex-shrink-0">
                    <Image
                      src="/images/calamari-logo.png"
                      alt="Calamari.lol Rust Logo"
                      width={48}
                      height={48}
                  ...
                  <div className="text-center sm:text-left">
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 bg-gradient-to-r from-white via-red-200 to-red-400 bg-clip-text text-transparent">
                      Calamari.lol Rust
                    </h1>
                    <div className="flex items-center justify-center sm:justify-start space-x-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="ml-1 text-gray-400 text-sm sm:text-base">3.2K+ users</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Pricing Card */}
              <motion.div
                className="bg-gradient-to-br from-gray-900/50 to-black/50 rounded-2xl p-6 sm:p-8 border border-red-500/50 backdrop-blur-sm order-1 lg:order-2"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <div className="space-y-3 mb-8">
                  {variants.map((variant, index) => (
                    <motion.div
                      key={index}
                      className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-lg border border-gray-700/50 bg-gray-900/30 hover:border-red-500/30 transition-all space-y-3 sm:space-y-0"
                    >
                      <div className="text-center sm:text-left">
                        <div className="font-medium text-sm sm:text-base">Calamari.lol Rust - {variant.name}</div>
                      ...
                      <div className="flex items-center justify-center sm:justify-end space-x-4">
                        ...
                        <button
                          ...
                          className="px-3 sm:px-4 py-2 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 rounded-lg font-medium transition-all duration-300 text-xs sm:text-sm flex items-center space-x-2"
                        >
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-black to-gray-900/50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-gray-400 max-w-2xl mx-auto text-sm sm:text-base">
                Join thousands of satisfied users who trust Calamari.lol for their gaming enhancement needs
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 md:mb-4 bg-gradient-to-br from-red-600/20 to-red-900/20 rounded-full flex items-center justify-center">
                    <item.icon className="h-6 w-6 sm:h-8 sm:w-8 text-red-400" />
                  </div>
